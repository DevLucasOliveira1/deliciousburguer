...
function Hamburguers3(props) {
  
    const CloseBox = (index) => {

    const Box = document.querySelectorAll('.hamburguers3')
  ...
  return (
    ...
    <section className='add hamburguers3'>
        ...
        <div className='container center-y'>
            ...
            <div className='add-box flex'>
                ...
                <div style={{textAlign: 'center'}} className='w50'>
                    ...
                    <img className='center-y' src='../../../public/imagens/home/shop/hamburguer3.png'/>
                ...
                <div style={{textAlign: 'center', marginBottom: '20px'}} className='w100'>
                    ...
                    <p>Nosso Hambúrguer ele é feito usando os seguintes ingredientes: Pão, Carne, Queijo Cheddar, Cheddar.</p>
