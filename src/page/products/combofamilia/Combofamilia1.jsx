...
function Combofamilia1(props) {
  
    const CloseBox = (index) => {

    const Box = document.querySelectorAll('.combofamilia1')
  ...
  return (
    ...
    <section className='add combofamilia1'>
        ...
        <div className='container center-y'>
            ...
            <div className='add-box flex'>
                ...
                <div style={{textAlign: 'center'}} className='w50'>
                    ...
                    <img className='center-y' src='../../../public/imagens/home/shop/combofamilia1.png'/>
                ...
                <div style={{textAlign: 'center', marginBottom: '20px'}} className='w100'>
                    ...
                    <p>Nosso Hambúrguer ele é feito usando os seguintes ingredientes: Pão, Gergelim, Queijo Cheddar, Tomate, Carne.</p>
