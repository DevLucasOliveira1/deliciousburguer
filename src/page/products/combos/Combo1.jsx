...
function Combo1(props) {
  
    const CloseBox = (index) => {

    const Box = document.querySelectorAll('.combo1')
    ...
    const product = {
        name: 'Burguer Tradicional + Fritas P + Refrigerante',
        price: 20,
        image: 'combo1.png',
        quantity,
        observation
        ...
        <div className='container center-y'>
            ...
            <div className='add-box flex'>
                ...
                <div style={{textAlign: 'center'}} className='w50'>
                    ...
                    <img className='center-y' src='../../../public/imagens/home/shop/combo1.png'/>
                ...
                <div style={{textAlign: 'center', marginBottom: '20px'}} className='w100'>
                    ...
                    <p>Nosso Hambúrguer ele é feito usando os seguintes ingredientes: Pão, Gergelim, Queijo Cheddar, Tomate, Carne, Ketchup.</p>
