...
function Bebidas1(props) {
  
    const CloseBox = (index) => {

    const Box = document.querySelectorAll('.bebidas1')
  ...
  return (
    ...
    <section className='add bebidas1'>
        ...
        <div className='container center-y'>
            ...
            <div className='add-box flex'>
                ...
                <div style={{textAlign: 'center'}} className='w50'>
                    ...
                    <img className='center-y' src='../../../public/imagens/home/shop/bebida1.png'/>
